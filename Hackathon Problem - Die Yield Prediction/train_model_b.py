"""
================================================================================
Model B: Random Forest with Die-Level + Spatial Context + Block-Level Readings
...
def main():
    ...
    print("=" * 75)
    print("  Model B: Die-Level (500) + Spatial Context + Sub-Die Block Readings (2,000)")
    print("=" * 75)
    ...
    # 5. Train / Validation Split (Identical wafer split as Model A)
    ...
    # 6. Train Balanced Random Forest for Model B
    print("\nTraining Balanced Random Forest Classifier (Model B)...")
    ...
    val_probs_b = rf_b.predict_proba(X_val)[:, 1]
    ...
    print(f"Optimal Threshold for Model B: {optimal_threshold_b:.4f} (Validation Fail F1: {best_val_f1_b:.4f})")
    ...
    test_probs_b = rf_b.predict_proba(X_test)[:, 1]
    ...
    print("\n" + "=" * 75)
    print("                 MODEL B (DIE + SPATIAL + BLOCK) TEST RESULTS                ")
    print("=" * 75)
    ...
    print("\nGenerating Model B Interpretability Artifacts...")
    ...
    all_test_probs_b = rf_b.predict_proba(all_test_X_b)[:, 1]
    ...
    sub_path_b = "predictions_model_b.csv"
