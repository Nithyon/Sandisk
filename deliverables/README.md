...
| Model A per-die explanation | `reports/model_A_per_die_explanation.png` and its original-feature contribution CSV |
| Model A spatial contribution | `reports/model_A_spatial_contribution.png` |
| Model B block analysis | `reports/model_B_block_pattern_analysis.png`, per-die block-position plot, and position-analysis CSV |
| Imbalance and overlap analysis | Probability-overlap plot, operating-tradeoff plot/CSV, and `FINAL_ANALYSIS.md` |
